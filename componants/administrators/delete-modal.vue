			...
			<div @click.stop class="bg-white rounded-xl shadow-lg p-6 w-full max-w-md m-3">
				...
				<div class="flex items-center mb-4">
					<p class="text-gray-700 text-md">
						Vous êtes sur le point de supprimer le compte de <b>{{ selectedAdministrator.name }}</b>.
						Cette action empêchera l’utilisateur de se connecter ou d’accéder à ses données et supprimera définitivement
						l’utilisateur.
					</p>
				</div>
				...
				<div class="my-3 flex justify-center gap-2">
					<button @click="emits('confirm')"
						...
						<span v-if="!isLoading">Oui, <b>supprimer</b></span>
						<Loader v-else/>
					</button>
